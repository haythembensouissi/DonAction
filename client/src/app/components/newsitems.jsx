...
import defaultImage from "../../../public/contact.png";
  ...
  return (
    <div style={{ maxWidth: "345px", width: "100%", display: "inline-block", margin: "10px", textAlign: "center" }}>
      <div className="card bg-dark text-light" style={{ width: "100%", height: "100%" }}>
        <img src={src || defaultImage} className="card-img-top news-item-image" alt="News" style={{ width: "100%", height: "200px", objectFit: "cover" }} />
